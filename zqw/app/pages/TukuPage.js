...
const http_url = 'http://xuanche.17350.com/api/wechat/photo';
export default class Tunavigator extends Component < Props > {
  constructor(props) {
    super(props);
    this.state = {
      drawerOpen: false,
  ...
  _renderItemView = ({
    ...
    return (
      <TouchableHighlight 
          onPress={ () => this.props.navigation.navigate('tukuinfo',{id:item.id,title:item.title}) }
          underlayColor='rgba(255, 255, 255, 0)'
          style={styles.item}
        >
          <View>
            <Image source={{uri:item.thumb}} style={styles.image}/>
            <Text style={styles.count}>{item.total}张</Text>
